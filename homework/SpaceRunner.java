 ...
 * - Принимающий 2 космический объекта и определяющий силу гравитации между ними (можно придумать любую формула на основании расстоянии между
 * объектами и т.д.)
...
public class SpaceRunner {
    ...
    public static void main(String[] args) {
        Planet planet = new Planet(6370, 6e24);
        Asteroid asteroid = new Asteroid(480, 9e20, 2.55);
        Satellite satellite = new Satellite(15, 40000000, 35700);
        Star star = new Star(7e5, 2e23, 6e3);
        System.out.println(planet);
        System.out.println(asteroid);
        System.out.println(satellite);
        System.out.println(star);
        System.out.println(SpaceUtils.isStar(planet));
        System.out.println(SpaceUtils.isStar(star));
        System.out.println(SpaceUtils.gravitationalForce(satellite, planet));
        System.out.println(asteroid.isWeightEqual(satellite));
    }
}
